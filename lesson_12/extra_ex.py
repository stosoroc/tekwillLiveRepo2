# 1.	Scrieţi o funcţie care primeşte 3 parametri: nume, prenume, varsta, în această ordine, şi calculează care va fi preţul biletului de intrare la un muzeu pentru persoana respectivă, în modul următor:
